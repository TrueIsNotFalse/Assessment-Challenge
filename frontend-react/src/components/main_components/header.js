...
// svg for icons to display social media, clickable and will open new window
      ...
      <AppBar className={classes.header} position='static'>
        <Toolbar>
          ...
          <Typography variant='h6' className={classes.title}>
            Welcome Satya Kaligotla and Berkshire team!
          </Typography>
        ...
        <Container className={classes.text} maxWidth='md'>
          <ScrollAnimation duration={5} animateIn='fadeIn'>
            ...
            <Typography align='center' paragraph variant='h6'>
              Custom dark theme similiar to my Android Phone.
            </Typography>
